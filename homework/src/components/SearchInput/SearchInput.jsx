...
function SearchInput({value, onChange, placeholder}) {
  ...
  return (
    <div className={styles['input-wrapper']}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles['search-icon']}>
        ...
        <input className={styles['input-search']} type="text" placeholder={placeholder} value={value} onChange={onChange}/>
    </div>
  )
}

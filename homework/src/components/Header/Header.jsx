    ...
    <header className={styles['header']}>
        ...
        <nav className={styles['header-wrapper']}>
            <ul className={styles['header-menu-list']}>
                <li className={styles['header__menu__list-item']}>
                    <a className={styles['header__menu__list-link']} href='#0'>Поиск фильмов</a>
                </li>
                <li className={styles['header__menu__list-item']}>
                    <a className={styles['header__menu__list-link']} href='#0'>Мои фильмы</a>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="12" cy="12" r="12" fill="#7B6EF6"/>
                    <path d="M9.358 14.788C10.254 14.0413 10.968 13.4207 11.5 12.926C12.032 12.422 12.4753 11.8993 12.83 11.358C13.1847 10.8167 13.362 10.2847 13.362 9.762C13.362 9.286 13.25 8.91267 13.026 8.642C12.802 8.37133 12.4567 8.236 11.99 8.236C11.5233 8.236 11.164 8.39467 10.912 8.712C10.66 9.02 10.5293 9.44467 10.52 9.986H8.616C8.65333 8.866 8.98467 8.01667 9.61 7.438C10.2447 6.85933 11.0473 6.57 12.018 6.57C13.082 6.57 13.8987 6.85467 14.468 7.424C15.0373 7.984 15.322 8.726 15.322 9.65C15.322 10.378 15.126 11.0733 14.734 11.736C14.342 12.3987 13.894 12.9773 13.39 13.472C12.886 13.9573 12.228 14.5453 11.416 15.236H15.546V16.86H8.63V15.404L9.358 14.788Z" fill="white"/>
                    </svg>
                </li>
                <li className={styles['header__menu__list-item']}>
                    <a className={styles['header__menu__list-link']} href='#0'>Войти</a>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
